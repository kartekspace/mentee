...
class ApplicationBloc {
  ...
  final languageControl = StreamController<Locale>.broadcast();
  Stream<Locale> get appLocale => languageControl.stream;
  ...
  void _mapEventToState(ApplicationEvent event) {
    ...
    if (event is AppLoadEvent) {
      languageControl.sink.add(Locale(event.langCode));
    }
  }
